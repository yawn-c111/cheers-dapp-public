...
import type { IDaoPoolFactory, IDaoPoolFactoryInterface } from '../../../contracts/interfaces/IDaoPoolFactory';
...
export class IDaoPoolFactory__factory {
  ...
  static connect(address: string, signerOrProvider: Signer | Provider): IDaoPoolFactory {
