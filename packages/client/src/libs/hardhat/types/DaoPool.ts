...
export interface DaoPoolInterface extends utils.Interface {
  ...
  encodeFunctionData(functionFragment: 'withdrowCher', values: [PromiseOrValue<BigNumberish>]): string;
  ...
  decodeFunctionResult(functionFragment: 'withdrowCher', data: BytesLike): Result;
...
export interface DaoPool extends BaseContract {
  ...
  callStatic: {
    ...
    withdrowCher(_cherAmount: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<void>;
  };
